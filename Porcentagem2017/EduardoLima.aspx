<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EduardoLima.aspx.cs" Inherits="Porcentagem2017.EduardoLima" %>
...
<body>
    ...
    <div>
        ...
        <p></p>
        <asp:Label class="nome" runat="server" Text="Eduardo Francisco Tenorio De Lima"></asp:Label>
        <p></p>
