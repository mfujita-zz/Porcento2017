<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gabriel.aspx.cs" Inherits="Porcentagem2017.Gabriel" %>
...
<body>
    ...
    <div>
        ...
        <p></p>
        <asp:Label class="nome" runat="server" Text="Gabriel Leonardo Moreira"></asp:Label>
        <p></p>
