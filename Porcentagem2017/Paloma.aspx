<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Paloma.aspx.cs" Inherits="Porcentagem2017.Paloma" %>
...
<body>
    ...
    <div>
        ...
        <p></p>
        <asp:Label class="nome" runat="server" Text="Paloma Zancane"></asp:Label>
        <p></p>
