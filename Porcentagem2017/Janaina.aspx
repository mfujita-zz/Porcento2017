<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Janaina.aspx.cs" Inherits="Porcentagem2017.Janaina" %>
...
<body>
    ...
    <div>
        ...
        <p></p>
        <asp:Label class="nome" runat="server" Text="Janaina Silverio Granja"></asp:Label>
        <p></p>
